...
# in the email
prompt = f"""Extract the list of the cities, countries mentioned inthe email
...
prompt = f"""Extract the list of activities Daniel did on the trip as given in the email.
